$(document).ready(function(){
    ...
    $(".add-more").click(function(e){
        ...
        var newIn = '<div id="field' + next + '" name="field' + next + '" class="col-xs-8 col-md-8"><br><input autocomplete="off" placeholder="Ex: Homework" class="form-control" type="text"></div>';
        var newInput = $(newIn);
